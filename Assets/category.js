document.addEventListener("DOMContentLoaded", function () {
  ...
  const dogDefaultImage = "https://cdn.shopify.com/s/files/1/0611/7992/0584/files/dog-paw-pawinspired.jpg?v=1744794386";
  ...
  const catDefaultImage = "https://cdn.shopify.com/s/files/1/0611/7992/0584/files/cat-paw-pawinspired.jpg?v=1744794386";
...
const smallPetDefaultImage = "https://cdn.shopify.com/s/files/1/0611/7992/0584/files/guinea-pig-paw-pawinspired.jpg?v=1744794386";
...
smallPetTags.forEach(tag => {
  tag.addEventListener("click", () => {
    ...
    if (smallPetImageMap[label]) {
      ...
      smallPetImage.src = smallPetDefaultImage;
